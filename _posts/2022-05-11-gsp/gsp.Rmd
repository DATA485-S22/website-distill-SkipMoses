...
The program of Dong et. al. can be solved efficently using the Python package [CVXPY](https://www.cvxpy.org/). An implementation of the algorithm can be found [here](https://github.com/SkipMoses/gl_sig_rep). 
...
We can see by inspection the algorithm appears to do a decent job learning the network. Detailed results on the preformance of the algrithm can be found in  @dong2016learning .
